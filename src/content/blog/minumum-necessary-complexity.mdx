...
<Image src={diagram} alt="Diagram of files as connected boxes, representing code base complexity" style="width: 120%; max-width: none; flex-shrink: 0; position: relative; left: 50%; transform: translateX(-50%);" />
...
<Image src={reposInReality} alt="Diagram of files as connected boxes, representing code base complexity" style="width: 110%; max-width: none; flex-shrink: 0; position: relative; left: 50%; transform: translateX(-50%);" />
