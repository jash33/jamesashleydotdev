...
<img src="/jamesashleydotdev/repos in reality.png" alt="Diagram of files as connected boxes, representing code base complexity" style="width: 110%;
    max-width: none;
    flex-shrink: 0;
    position: relative;
    left: 50%;
...
<i>The tendency of LLMs to prefer verbosity, writing unnecessary fallbacks, not removing dead code, writing new functions/components/classes instead of using existing ones, poor variable/file names. (obscurity) </i>

Those that are more fundamental include:

<i> Creating bugs that do not surface in code review or tests. (obscurity) </i>
